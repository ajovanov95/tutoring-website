...
pricelistTable = 
    ...
    in
        ...
        [
            ...
            tbody [] 
            [
                mkRow "1 час од 45 минути по програмирање" "200 денари",
                mkRow "2 часa од 45 минути по програмирање" "360 денари",
                mkRow "3 часa од 45 минути по програмирање" "500 денари",
